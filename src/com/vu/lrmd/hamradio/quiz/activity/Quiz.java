...
import com.vu.lrmd.hamradio.quiz.App;
import com.vu.lrmd.hamradio.quiz.Config;
import com.vu.lrmd.hamradio.quiz.R;
import com.vu.lrmd.hamradio.quiz.fragment.FlashcardFragment;
import com.vu.lrmd.hamradio.quiz.fragment.MultipleChoiceFragment;
import com.vu.lrmd.hamradio.quiz.fragment.QuestionFragment.QuestionListener;
import com.vu.lrmd.hamradio.quiz.model.DataSource;
import com.vu.lrmd.hamradio.quiz.model.Question;
import com.vu.lrmd.hamradio.quiz.util.SoundPoolAssistant;
import com.vu.lrmd.hamradio.quiz.util.Task;
...
public class Quiz extends RoboFragmentActivity implements QuestionListener {
	...
	private String getProgressText() {
		return String.format("Klausimas %d iš %d", mQuestionIndex + 1,
				mQuestions.length);
	}
	...
	private String getScoreText() {
		...
		return String.format("%d iš %d teisingai (%d%%)", mNumCorrect,
				mNumAnswered, pct);
	}
